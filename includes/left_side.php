        ...
        <ul id="slide-out" class="sidenav">
            <li>
                <ul class="collapsible">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">dashboard</i><span class="hide-menu"> My Dashboard</span></a>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">group</i><span class="hide-menu"> Update Details</span></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="authentication-recover-password.html"><i class="material-icons">assignment_ind</i><span class="hide-menu"> Recover Password</span></a></li>
