        ...
        <ul id="slide-out" class="sidenav">
            <li>
                <ul class="collapsible">
                    ...
                    <li class="small-cap"><span class="hide-menu">User Management</span></li>
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="ui-user-card.html"><i class="material-icons">assignment_ind</i><span class="hide-menu"> View Users</span></a></li>
                                <li><a href="ui-user-contacts.html"><i class="material-icons">assignment_turned_in</i><span class="hide-menu"> Activate Users</span></a></li>
                                <li><a href="ui-user-contacts.html"><i class="material-icons">assignment_turned_in</i><span class="hide-menu"> Deactivate Users</span></a></li>
                                <li><a href="ui-user-contacts.html"><i class="material-icons">assignment_turned_in</i><span class="hide-menu"> Reset Password</span></a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- <li>
